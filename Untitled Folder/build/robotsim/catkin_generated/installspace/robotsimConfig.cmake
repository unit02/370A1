...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotsim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eliza/threeohsix/install/${idir}'.  Ask the maintainer 'eliza <eliza@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/eliza/threeohsix/install/lib;/home/eliza/threeohsix/devel/lib;/opt/ros/indigo/lib)
